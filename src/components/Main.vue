               ...
               <div v-if="this.needle.length > 0" class="text-center">
                    ...
                    <ul class="d-flex flex-wrap pt-3 mx-2">
                        <li class=" mb-5 d-flex flex-wrap mx-auto" v-for="(element, index) in filterFilm" :key='index'>
                             <img id="banner-image"  :src="pathGenerator(element)" :alt="element.title">
                             <div class="content ">
                                ...
                                <h5>Voto: </h5> <span><i v-for="(star,counter) in stars " :key='counter' :class="starHighLighter(element,counter)" class="fas fa-star">{{star}}</i></span>
                    ...
                    <ul class="d-flex flex-wrap pt-3 mx-2">
                        <li class=" mb-5 d-flex flex-wrap mx-auto" v-for="(element, index) in filterTVs" :key='index'>
                            <img id="banner-image"  :src="pathGenerator(element)" :alt="element.name">
                            <div class="content ">
